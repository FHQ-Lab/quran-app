  ...
  return (
    ...
    <div className="flex items-center gap-2">
      ...
      <input
        ...
        className="flex-grow p-2 border border-green-600 rounded-full focus:outline-none focus:ring-2 focus:ring-green-600 transition-transform hover:scale-[1.01] active:scale-95"
      ...
      {recognition ? (
        <button
          ...
          className="p-3 bg-gray-100 border border-green-600 rounded-xl hover:bg-green-50 transition-transform hover:scale-[1.05] active:scale-95 disabled:opacity-50"
      ...
      {/* Tombol Cari */}
      <button
        className="p-3 font-semibold text-white border border-green-600 rounded-xl hover:bg-green-50 transition-transform hover:scale-[1.05] active:scale-95 disabled:opacity-50"
