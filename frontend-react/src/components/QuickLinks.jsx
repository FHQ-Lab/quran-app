      ...
      <div className="inline-flex gap-3">
        ...
        {links.map((link) => (
          <button
            ...
            className="px-5 py-2 text-sm font-semibold text-green-800 bg-green-100 rounded-full hover:bg-green-200 whitespace-nowrap transform transition-all duration-300 hover:-translate-y-2 hover:shadow-xl cursor-pointer"
          >
            {link.label}
          </button>
        ))}
